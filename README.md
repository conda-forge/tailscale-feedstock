...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/tailscale-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/tailscale-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add tailscale tailscaled
# for installing globally
pixi global install tailscale tailscaled
```
...
It is possible to list all of the versions of `tailscale` available on your platform:
...
```
pixi search tailscale --channel conda-forge
```
